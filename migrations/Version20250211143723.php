 ...
 */
final class Version20250211143723 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, reduction NUMERIC(8, 2) NOT NULL, total NUMERIC(8, 2) NOT NULL, coefficient NUMERIC(4, 2) NOT NULL, date_paiement DATETIME NOT NULL, adresse_facture VARCHAR(100) NOT NULL, date_livraison DATETIME NOT NULL, etat VARCHAR(50) NOT NULL, reference VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE paiement (id INT AUTO_INCREMENT NOT NULL, montant NUMERIC(8, 2) NOT NULL, date_paiement DATETIME NOT NULL, method_paiement VARCHAR(50) NOT NULL, statut_paiement VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
